...
**Tool naming:** Antigravity uses bare tool names (e.g., `session_init`, `search`) without prefixes. If a tool call fails with "No such tool available", refresh rules and match the tool list.
